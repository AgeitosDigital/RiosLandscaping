    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-forest-950/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        <Link href="/" className="group flex items-center gap-2">
          <span className="flex h-9 w-9 items-center justify-center rounded-full bg-forest-500 text-lg font-bold text-white">
            R
          </span>
          <div className="leading-tight">
            <p className="font-display text-lg font-semibold text-white group-hover:text-forest-200 transition-colors">
              {SITE.name}
            </p>
            <p className="text-xs text-forest-300">Houston, TX</p>
          </div>
        </Link>
